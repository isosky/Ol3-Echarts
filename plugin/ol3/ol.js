...
(function(root, factory) {
    ...
    function pa(a, c, d) { pa = Function.prototype.bind && -1 != Function.prototype.bind.toString().indexOf("native code") ? ma : na;
    ...
    function Ha(a, c) {
        for (var d = 0, e = va(String(a)).split("."), f = va(String(c)).split("."), g = Math.max(e.length, f.length), h = 0; 0 == d && h < g; h++) {
            ...
            do {
                ...
                d = Ia(0 == q[1].length ? 0 : parseInt(q[1], 10), 0 == r[1].length ? 0 : parseInt(r[1], 10)) || Ia(0 == q[2].length, 0 == r[2].length) || Ia(q[2], r[2]) } while (0 == d) }
        return d }
    ...
    function sb(a) {
        if (a && a.target) { a.target.removeEventListener(a.type, a.hg);
    ...
    Fb.prototype.b = function(a) {
        ...
        var d = this.va[a],
            e;
        if (d) { a in this.Fa || (this.Fa[a] = 0);
            for (var f = 0, g = d.length; f < g; ++f)
                if (!1 === d[f].call(this, c) || c.Vn) { e = !1;
                    break }
            c = this.Fa[a];
    ...
    function Tb(a, c, d) { a = Qa(a + 180, 360) - 180;
    ...
    function ac(a) { this.length = a.length || a;
        for (var c = 0; c < this.length; c++) this[c] = a[c] || 0 }
    ac.prototype.BYTES_PER_ELEMENT = 8;
    ac.prototype.set = function(a, c) { c = c || 0;
        for (var d = 0; d < a.length && c + d < this.length; d++) this[c + d] = a[d] };
    ac.prototype.toString = Array.prototype.join;
    if ("undefined" == typeof Float64Array) {
        try { ac.BYTES_PER_ELEMENT = 8 } catch (a) {}
    ...
    function Ac(a, c, d, e, f) { f = yc(Infinity, Infinity, -Infinity, -Infinity, f);
        return Bc(f, a, c, d, e) }
    ...
    */
    ...
    function ad(a) {
        ...
        else if ("string" === typeof a) { c = Zc[a];
            var d = $c || aa.proj4;
            void 0 === c && "function" == typeof d && void 0 !== d.defs(a) && (c = new Yc({ code: a }), nd(c)) } else c = null;
        return c }
    ...
    l.yc = Uc;
    l.G = function(a) { this.B != this.g && (this.A = this.Ld(this.A), this.B = this.g);
        var c = this.A;
        a ? (a[0] = c[0], a[1] = c[1], a[2] = c[2], a[3] = c[3]) : a = c;
        return a };
    l.Ab = function(a) {
        return this.kd(a * a) };
    l.hb = function(a, c) { this.oc(rd(a, c));
        return this };
    ...
    l.Hb = function() {
        return this.f };
    l.kd = function(a) { this.s != this.g && (nb(this.j), this.o = 0, this.s = this.g);
    ...
    function Gd(a, c, d, e, f, g, h, k, m, n, p) {
        ...
        for (var r = p ? p : [NaN, NaN], t = c + e; t < d;)
            if (Dd(a, t - e, t, e, h, k, r), q = Oa(h, k, r[0], r[1]), q < n) { n = q;
                for (p = 0; p < e; ++p) m[p] = r[p];
                m.length = e;
                t += e } else t += e * Math.max((Math.sqrt(q) - Math.sqrt(n)) / f | 0, 1);
        if (g && (Dd(a, d - e, c, e, h, k, r), q = Oa(h, k, r[0], r[1]), q < n)) { n = q;
            for (p = 0; p < e; ++p) m[p] = r[p];
            m.length = e }
        return n }

    function Hd(a, c, d, e, f, g, h, k, m, n, p) { p = p ? p : [NaN, NaN];
        var q, r;
        q = 0;
    ...
    function Ld(a, c, d, e, f) { f = void 0 !== f ? f : [];
        for (var g = 0; c < d; c += e) f[g++] = a.slice(c, c + e);
        f.length = g;
        return f }

    function Md(a, c, d, e, f) { f = void 0 !== f ? f : [];
        var g = 0,
            h, k;
        h = 0;
    ...
    function $d(a, c, d, e, f) { f = void 0 !== f ? f : !1;
        var g, h;
        g = 0;
        for (h = d.length; g < h; ++g) {
            var k = d[g],
    ...
    var Fe = Array.prototype.forEach ? function(a, c, d) { Array.prototype.forEach.call(a, c, d) } : function(a, c, d) {
    ...
    a: {
        var ef = "",
            ff = function() {
                ...
                if (Ye) return /(?:Version)[ \/]?(\S+)/.exec(a) }();ff && (ef = ff ? ff[1] : "");
        if (Ze) {
            var gf = cf();
            if (null != gf && gf > parseFloat(ef)) { df = String(gf);
                break a } }
        df = ef }
    var hf = {};
    ...
    function vf(a, c, d) {
        var e = arguments,
            ...
            g = e[0],
            h = e[1];
        if (!mf && h && (h.name || h.type)) { g = ["<", g];
            h.name && g.push(' name="', wa(h.name), '"');
            if (h.type) { g.push(' type="', wa(h.type), '"');
                var k = {};
                Xe(k, h);
                delete k.type;
                h = k }
    ...
    function wf(a, c, d) {
        function e(d) { d && c.appendChild(ga(d) ? a.createTextNode(d) : d) }
    ...
    Pf.prototype.i = function() {
        return this.a };
    Pf.prototype.setMap = function(a) { this.a && Af(this.element);
    ...
    function cg(a, c, d, e, f) { f = a.Da(c, f);
    ...
    function fg(a, c, d, e) { gg(a, c[0], c[1], d, !1, bg);
        var f = bg[1],
            g = bg[2];
        gg(a, c[2], c[3], d, !0, bg);
        a = bg[1];
    ...
    function lg(a, c, d) { c = void 0 !== c ? c : 42;
        var e = Mc(a);
        a = Lc(a);
        d = Qb(void 0 !== d ? d : 256);
    ...
    function og(a, c, d, e, f) { c = a.ld(c);
        if (!c) return !1;
                                                ...
                                                if (K in q.b)
                                                    for (var J = g[K], M, z = 0, B = q.b[K].length; z < B; ++z) {
                                                        ...
                                                        if (J.ua < Y.ua || J.wa > Y.wa)
                                                            if (ze(M, new we(Qa(J.ua, Ja), Qa(J.wa, Ja), J.za, J.Ba)) || J.wa - J.ua + 1 > Ja && ze(M, Y)) { q = !0;
                                                                break a }
                                                    }
                                                q = !1
                                        } else q = !0
    ...
    y(vg, Pf);
    vg.prototype.B = function(a) { a.preventDefault();
    ...
    y(xg, Pf);
    xg.prototype.j = function(a, c) { c.preventDefault();
        var d = this.a,
            e = d.aa();
        if (e) {
            var f = e.$();
    ...
    function Kg() {
        ...
        if ("undefined" !== typeof a && !Ue("Trident") && !Ue("MSIE")) {
            ...
            c.port1.onmessage = function() {
                if (ca(d.next)) { d = d.next;
                    var a = d.kg;
                    d.kg = null;
                    a() } };
            return function(a) { e.next = { kg: a };
                e = e.next;
    ...
    function Tg(a, c) {
        ...
        if (Rg()) {
            ...
            Sg(a, "matrix3d(" + e.join(",") + ")") } else if (Qg()) {
    ...
    function Vg(a, c) {
        var d, e, f = Ug.length;
        for (e = 0; e < f; ++e) try {
            if (d = a.getContext(Ug[e], c)) return d } catch (g) {}
        return null };
    var Wg, Xg = "undefined" !== typeof navigator ? navigator.userAgent.toLowerCase() : "",
        ...
        ch = function() {
            ...
            try {
                var a = Pg();
                return a ? (void 0 !== a.setLineDash && (bh = !0), !0) : !1 } catch (c) {
                return !1 } }(),
    ...
    function zh(a, c) {
        ...
        return d }
    l = yh.prototype;
    l.ol = function(a) { this.a[a.pointerId.toString()] = a;
        var c = zh(this, a);
        rh(this.b, th, c, a) };
    l.pl = function(a) {
        var c = zh(this, a);
    ...
    l.Uo = function(a) {
        ...
        this.i++;
        Eh(this, a, this.In) };
    l.In = function(a, c) { this.a[c.pointerId] = { target: c.target, out: c, Eh: c.target };
        var d = this.b;
        c.bubbles = !0;
        rh(d, Gh, c, a);
        d = this.b;
    ...
    function Sh(a, c) {
        ...
        d = new Qh(Th, a.f, c);
        a.b(d);
        0 !== a.j ? (aa.clearTimeout(a.j), a.j = 0, d = new Qh(Uh, a.f, c), a.b(d)) : a.j = aa.setTimeout(function() { this.j = 0;
    ...
    l.Gl = function(a) {
        if (a.clientX != this.g.clientX || a.clientY != this.g.clientY) { this.o = !0;
    ...
    l.Uk = function() { this.l && (sb(this.l), this.l = null);
        var a = this.ea();
    ...
    l.Wc = function(a, c, d) {
        return function(e, f) {
            return og(a, c, e, f, function(a) { d[e] || (d[e] = {});
                d[e][a.ja.toString()] = a }) } };
    ...
    l.Vb = function() {
        ...
        if ("fraction" == this.o || "fraction" == this.l) {
            if (!c) return null;
            a = this.c.slice(); "fraction" == this.o && (a[0] *= c[0]); "fraction" == this.l && (a[1] *= c[1]) }
        if ("top-left" != this.a) {
            if (!c) return null;
    ...
    yi.prototype.clear = function() { this.b = {};
        this.a = 0 };
    yi.prototype.get = function(a, c, d) { a = c + ":" + a + ":" + (d ? Oe(d) : "null");
    ...
    function Fi(a, c) {
        for (var d in a.g)
            if (!(d in c.layerStates)) { c.postRenderFunctions.push(a.wo.bind(a));
                break } }
    ...
    function Li(a, c) { Gi.call(this, function(c) {
    ...
    Li.prototype.f = function(a) {
        ...
        return c };
    Li.prototype.o = function(a) { a = a.target;
        var c = a.V();
    ...
    function Vi(a) { a = a.originalEvent;
        return a.altKey && !(a.metaKey || a.ctrlKey) && a.shiftKey }

    function Wi(a) { a = a.originalEvent;
    ...
    function Zi(a) { a = a.originalEvent;
        return !a.altKey && !(a.metaKey || a.ctrlKey) && !a.shiftKey }

    function $i(a) { a = a.originalEvent;
        return !a.altKey && !(a.metaKey || a.ctrlKey) && a.shiftKey }

    function aj(a) { a = a.originalEvent.target.tagName;
    ...
    function sj(a) {
        if (bj(a) && Wi(a) && this.H(a)) { this.c = a.pixel;
            this.a.setMap(a.map);
            var c = this.a,
                d = this.c;
            c.c = this.c;
    ...
    function yj(a) {
        ...
        if ("keydown" == a.type) {
            ...
            if (this.c(a) && (40 == d || 37 == d || 39 == d || 38 == d)) {
                ...
                Wb(d, c.Ma());
                f = this.o;
                if (g = c.bb()) f && 0 < f && e.Va(re({ source: g, duration: f, easing: pe })), e = c.Md([g[0] + d[0], g[1] + d[1]]), c.lb(e);
                a.preventDefault();
                c = !0 } }
        return !c };
    ...
    function Cj(a) {
        ...
        if ("wheel" == a.type || "mousewheel" == a.type) {
            ...
            var e; "wheel" == a.type ? (e = d.deltaY, Yg && d.deltaMode === aa.WheelEvent.DOM_DELTA_PIXEL && (e /= ah), d.deltaMode === aa.WheelEvent.DOM_DELTA_LINE && (e *= 40)) : "mousewheel" == a.type && (e = -d.wheelDeltaY, Zg && (e /= 3));
            this.c += e;
    ...
    function dk(a) { void 0 === a.a && (a.a = a.b instanceof CanvasPattern || a.b instanceof CanvasGradient ? x(a.b).toString() : "f" + (a.b ? Oe(a.b) : "-"));
        return a.a };
    ...
    function hk(a, c) {
        ...
        for (var e = d - a.a, f = a.c, g = a.g, h = 0; h < d;) {
            ...
            if (ga(c))
                for (; h < d;) {
                    if (f[g++] = c.charCodeAt(h++), g == a.a) { gk(a, f);
                        g = 0;
                        break } } else
                    for (; h < d;)
    ...
    l.sn = function() {
        return this.b };
    l.Dh = function(a) { ia(a) ? this.g = a : "string" === typeof a ? this.g = function(c) {
            return c.get(a) } : a ? void 0 !== a && (this.g = function() {
            return a }) : this.g = mk;
        this.i = a };
    ...
    function pk() {
        if (!ok) {
            var a = new ck({ color: "rgba(255,255,255,0.4)" }),
    ...
    l.Nd = function(a) {
        if (Qc(this.c, a.G())) {
            if (this.a || this.b) { this.a && vk(this, this.a);
    ...
    l.We = function(a) {
        if (Qc(this.c, a.G())) {
            if (this.b || this.a) { this.a && vk(this, this.a);
                this.b && wk(this, this.b);
                var c = this.f;
                c.beginPath();
    ...
    l.Qb = function(a, c) {
        if (a) {
            var d = a.b;
            this.a = { fillStyle: Qe(d ? d : Yj) } } else this.a = null;
        if (c) {
            var d = c.b,
                e = c.f,
                f = c.g,
            ...
            switch (B[0]) {
                ...
                case 5:
                    ...
                    for (K = B[9]; r < t; r += 2) { B = n[r] + Ja;
                        ...
                        if (1 != z || 0 !== D) jc(v, a), c.transform(a[0], a[1], a[4], a[5], a[12], a[13]) }++p;
                    break;
                case 6:
                    if (void 0 !==
    ...
    function Qk(a, c, d, e, f) {
        ...
        return e }
    l = Pk.prototype;
    l.Ye = function() { this.f || (this.f = rc(this.T), 0 < this.c && qc(this.f, this.resolution * (this.c + 1) / 2, this.f));
        return this.f };
    ...
    l.Ue = function(a, c) {
        var d = this.g,
            e = d.lineWidth;
        if (void 0 !== d.strokeStyle && void 0 !== e) { Rk(this);
            Kk(this, c);
    ...
    l.Bb = function() {
        return this.c };
    l.G = function() { this.a || (this.a = "Point" === this.g ? zc(this.b) : Ac(this.b, 0, this.b.length, 2));
        return this.a };
    l.Mb = function() {
        return this.b };
    ...
    function ll(a, c, d, e, f, g, h, k, m, n) {
        ...
        if (t || !a.i || Qc(p, a.i)) {
            ...
            if (0 < n && (t || (q = a.a([(c[0] + e[0]) / 2, (c[1] + e[1]) / 2]), p = r ? (Qa(g[0], a.b) + Qa(k[0], a.b)) / 2 - Qa(q[0], a.b) : (g[0] + k[0]) / 2 - q[0], q = (g[1] + k[1]) / 2 - q[1],
                    t = p * p + q * q > a.s), t)) { Math.abs(c[0] - e[0]) <= Math.abs(c[1] - e[1]) ? (r = [(d[0] + e[0]) / 2, (d[1] + e[1]) / 2], p = a.a(r), q = [(f[0] + c[0]) / 2, (f[1] + c[1]) / 2], t = a.a(q), ll(a, c, d, r, q, g, h, p, t, n - 1), ll(a, q, r, e, f, t, p, k, m, n - 1)) : (r = [(c[0] + d[0]) / 2, (c[1] + d[1]) / 2], p = a.a(r), q = [(e[0] + f[0]) / 2, (e[1] + f[1]) / 2], t = a.a(q), ll(a, c, r, q, f, g, p, t, m, n - 1), ll(a, r, d, e, q, p, h, k, t, n - 1));
                return }
            if (r) {
                if (!a.l) return;
                a.o = !0 }
    ...
    nl.prototype.load = function() {
        if (0 == this.state) { this.state = 1;
            ...
            2 == a || 3 == a ? this.wd() : (this.xd = C(this.pb, "change", function() {
                var a = this.pb.V();
                if (2 == a || 3 == a) sb(this.xd), this.xd = null, this.wd() }, this), this.pb.load()) } };
    ...
    pl.prototype.B = function(a, c, d, e) {
        ...
        if (f && e && !qd(f, e)) {
            ...
            this.a = new nl(f, e, a, c, d, function(a, c, d) {
                return this.gd(a, c, d, f) }.bind(this));
            this.na = this.g;
            return this.a }
        f && (e = f);
        return this.gd(a, c, d, e) };
    pl.prototype.o = function(a) { a = a.target;
        switch (a.V()) {
            case 1:
                this.b(new rl(sl, a));
                break;
    ...
    y(wl, pl);
    wl.prototype.gd = function(a, c, d, e) { c = ql(this, c);
        var f = this.S;
    ...
    l.Vd = function() { this.f && (sb(this.f), this.f = null);
        var a = this.W();
    ...
    function Tl(a, c) {
        return Sl(a, c, function(a, c) { this.pf(c);
            this.Zh(a) }, function() { this.state = 3;
            Wf(this) }) }

    function Ul(a, c) {
        return Sl(a, c, function(a) { this.Fc(a) }, ta) };
    ...
    (function() {
        ...
        (function() {
            ...
            c.prototype = {
                ...
                Aa: function(a) { a && this.$f(a, this.data.height - 1);
                    return this },
                clear: function() { this.data = { children: [], height: 1, bbox: [Infinity, Infinity, -Infinity, -Infinity], La: !0 };
                    return this },
                remove: function(a) {
                    if (!a) return this;
    ...
    l.clear = function(a) {
        if (a) {
            ...
            this.c || (this.l = {}, this.j = {}, this.o = {}) } else if (this.a) { this.a.forEach(this.Mf, this);
    ...
    function km(a, c, d) { a.wb([c[0], c[1], c[0], c[1]], function(a) {
    ...
    l.G = function() {
        return this.a.G() };
    l.vg = function(a) { a = this.j[a.toString()];
        return void 0 !== a ? a : null };
    l.wh = function() {
        return this.na };
    l.xh = function() {
        return this.S };
    l.yh = function(a) { a = a.target;
        var c = x(a).toString(),
            d = a.W();
    ...
    l.Jc = function(a, c, d) {
        ...
        for (g = a.length; f < g; ++f) {
            var h = a[f];
            em(e, h, function(a) {
                return wc(a.extent, h) }) || (this.D.call(this, h, c, d), e.Aa(h, { extent: h.slice() })) } };
    l.mb = function(a) {
        var c = x(a).toString();
    ...
    om.prototype.zc = function(a, c, d, e) {
        if (this.f && this.f.a())
            if (this.a.ea() instanceof mm) {
                if (a = a.slice(), mi(c.pixelToCoordinateMatrix, a, a), this.ib(a, c, Tc, this)) return d.call(e, this.a) } else if (this.i || (this.i = cc(), jc(this.l, this.i)), c = [0, 0], mi(this.i, a, c), this.j || (this.j = Pg(1, 1)), this.j.clearRect(0, 0, 1, 1), this.j.drawImage(this.f ? this.f.a() : null, c[0], c[1], 1, 1, 0, 0, 1, 1), 0 < this.j.getImageData(0, 0, 1, 1).data[3]) return d.call(e, this.a) };
            ...
            if (n) a: {
                ...
                for (h = a.j.length - 1; 0 <= h; --h)
                    for (q.bindTexture(3553, a.j[h]), n = 0 < h ? a.i[h - 1] : 0, t = a.i[h]; 0 <= g && a.g[g] >= n;) {
                        ...
                        d = a.s[g];
                        e = x(d).toString();
                        if (void 0 === k[e] && d.W() && (void 0 === p || Qc(p, d.W().G())) && (q.clear(q.COLOR_BUFFER_BIT | q.DEPTH_BUFFER_BIT), q.drawElements(4, t - v, f, v * c), t = m(d))) { a = t;
                            break a }
                        t = v;
                        g--
                    }
    ...
    function un(a, c, d) {
        var e = a.f.f;
        if (void 0 === a.j || a.j != d) { c.postRenderFunctions.push(qa(function(a, c, d) { a.isContextLost() || (a.deleteFramebuffer(c), a.deleteTexture(d)) }, e, a.i, a.qb));
            c = Wm(e, d, d);
    ...
    wn.prototype.zc = function(a, c, d, e) {
        if (this.c && this.c.a())
            if (this.a.ea() instanceof mm) {
                if (a = a.slice(), mi(c.pixelToCoordinateMatrix, a, a), this.ib(a, c, Tc, this)) return d.call(e, this.a) } else {
        ...
        if (this.o && ye(this.o, q) && this.l == m.g) v = this.B;
            ...
            for (ba = q.ua; ba <= q.wa; ++ba)
                for (oa = q.za; oa <= q.Ba; ++oa) {
                    ...
                    I = J.V();
                    if (2 == I) {
                        if (Rf(e.a, J.gb())) { d[p][J.ja.toString()] = J;
                            continue } } else if (4 == I || 3 == I && !Y) continue;
                    B = !1;
                    I = cg(n, J.ja, M, Ja, K);
    ...
    l.ck = function() {
        return this.l };
    l.bk = function(a) { a = this.wf[a.toString()];
        return void 0 !== a ? a : null };
    l.Qj = function() {
        return this.j };
    l.uc = function() {
    ...
    l.Xk = function() { this.S && (sb(this.S), this.S = null);
        var a = this.aa();
        a && (this.S = C(a, "propertychange", this.Yk, this));
        this.render() };
    l.Dk = function() { this.render() };
    l.Ek = function() { this.render() };
    l.Ck = function() { this.H && (this.H.forEach(sb), this.H = null);
        var a = this.uc();
    ...
    function Jn(a) {
        ...
        if (void 0 === a.logo || "boolean" === typeof a.logo && a.logo) e["data:image/png;base64,"] =
            ...
            var f = a.logo; "string" === typeof f ? e[f] = "" : ja(f) && (e[f.src] = f.href) }
        ...
        for (k = g.length; h < k; ++h) {
            ...
            if ("canvas" == m) {
                if (ch) { f = Bm;
                    break } } else if ("dom" == m) { f = Jm;
                break } else if ("webgl" == m && Wg) { f = Fn;
                break } }
        var n;
    ...
    l.yk = function() { yf(this.f);
        var a = this.ce();
        a && this.f.appendChild(a) };
    l.Jk = function() { this.c && (Af(this.f), sb(this.c), this.c = null);
        var a = this.de();
    ...
    l.xk = function(a) {
        if (!this.B && a.b.target === this.element.firstElementChild && (le(this.a.aa(), 1), this.H = a.clientX, this.D = a.clientY, this.B = !0, 0 === this.A.length)) { a = this.Gg;
            var c = this.Hg;
    ...
    function bo(a) { a = a ? a : {};
        ...
        Pf.call(this, { element: c, target: a.target }) }
    y(bo, Pf);
    bo.prototype.j = function(a) { a.preventDefault();
        var c = this.a;
        a = c.aa();
    ...
    function zk(a) { a.l != a.g && (a.i = a.tg(.5, a.i), a.l = a.g);
        return a.i }
    l.Hc = function(a) {
        var c = [];
        c.length = Nd(this.v, 0, this.v.length, this.a, a, c, 0);
    ...
    l.rj = function(a) {
        if (this.v) {
            ...
            var d, e;
            d = 0;
            for (e = a.length; d < e; ++d) a[d] += c } else this.v = a.ga().slice(), a = a.Bb().slice(), this.i.push();
        this.i.push(a);
        this.u() };
    l.clone = function() {
    ...
    var vo = { Point: function(a) {
                ...
                return new S(a.paths[0], uo(a)) }, Polygon: function(a) {
                return new F(a.rings, uo(a)) }, MultiPoint: function(a) {
                return new oo(a.points, uo(a)) }, MultiLineString: function(a) {
                return new T(a.paths, uo(a)) }, MultiPolygon: function(a) {
    ...
    l.yc = function(a, c) {
        ...
        return !1 };
    l.Ld = function(a) { yc(Infinity, Infinity, -Infinity, -Infinity, a);
    ...
    var Fo = { Point: function(a) {
                ...
                return new S(a.coordinates) }, Polygon: function(a) {
                return new F(a.coordinates) }, MultiPoint: function(a) {
                return new oo(a.coordinates) }, MultiLineString: function(a) {
                return new T(a.coordinates) }, MultiPolygon: function(a) {
                return new po(a.coordinates) }, GeometryCollection: function(a, c) {
    ...
    l.Fe = function(a, c, d) {
        var e = d[d.length - 1].srsName; "PolygonPatch" !== a.nodeName && e && a.setAttribute("srsName", e); "Polygon" === a.nodeName || "PolygonPatch" === a.nodeName ? (c = c.Qd(), Rl({ node: a, srsName: e }, bp, this.Si, c, d, void 0, this)) : "Surface" === a.nodeName && (e = Bl(a.namespaceURI, "patches"), a.appendChild(e), a = Bl(e.namespaceURI, "PolygonPatch"), e.appendChild(a), this.Fe(a, c, d)) };
    l.Ae = function(a, c, d) {
    ...
    Zo.prototype.s = function(a, c) { c = go(this, c);
        ...
        this.De(d, a, [e]);
        return d };
    Zo.prototype.a = function(a, c) { c = go(this, c);
    ...
    function jp(a, c, d) { a.push(parseFloat(c.getAttribute("lon")), parseFloat(c.getAttribute("lat"))); "ele" in d ? (a.push(d.ele), delete d.ele) : a.push(0); "time" in d ? (a.push(d.time), delete d.time) : a.push(0);
        return a }
    ...
    function pp(a, c) {
        var d = c[0],
            e = P({ flatCoordinates: [], ends: [] }, qp, a, c);
        if (e) {
            var f = e.flatCoordinates;
            delete e.flatCoordinates;
            var g = e.ends;
    ...
    var tp = { rte: np, trk: pp, wpt: rp },
        ...
        op = O(ip, { name: L(U), cmt: L(U), desc: L(U), src: L(U), link: kp, number: L(So), extensions: mp, type: L(U), rtept: function(a, c) {
                var d = P({}, vp, a, c);
                d && jp(c[c.length - 1].flatCoordinates, a, d) } }),
        vp = O(ip, { ele: L(Qo), time: L(Po) }),
        qp = O(ip, { name: L(U), cmt: L(U), desc: L(U), src: L(U), link: kp, number: L(So), type: L(U), extensions: mp, trkseg: function(a, c) {
                var d = c[c.length - 1];
                Ql(wp, a, c);
    ...
    hp.prototype.a = function(a, c) { c = go(this, c);
        ...
        for (p = e.length; n < p; ++n) {
            ...
            if ("B" == q.charAt(0)) {
                if (r = Rp.exec(q)) {
                    ...
                    var A = parseInt(r[7], 10) + parseInt(r[8], 10) / 6E4; "W" == r[9] && (A = -A);
    ...
    function rq(a) { a = a.charCodeAt(0);
    ...
    function nq(a, c) { c && !a.f && (sq(a), a.g = null, a.b.forEach(function(a, c) {
            var f = c.toLowerCase();
    ...
    function Iq(a, c) {
        ...
        if (pb(a.Ha())) d = new vq({ text: c, offsetX: e[0], offsetY: e[1], textAlign: f });
        else {
            var d = a.Ha(),
                g = {},
                h;
    ...
    var gr = O(zq, { value: Jl(U) }),
        ...
        br = O(zq, { innerBoundaryIs: function(a, c) {
        ...
        lr = O(zq, { Icon: L(function(a, c) {
                var d = P({}, kr, a, c);
                return d ? d : null }), heading: L(Qo), hotSpot: L(function(a) {
                var c = a.getAttribute("xunits"),
                    d = a.getAttribute("yunits");
                return { x: parseFloat(a.getAttribute("x")), Tf: Hq[c], y: parseFloat(a.getAttribute("y")), Uf: Hq[d] } }), scale: L(Oq) }),
        ...
        rr = O(zq, { Style: L(cr), key: L(U), styleUrl: L(function(a) {
                var c = Cl(a, !1).trim();
        ...
        tr = O(zq, {
            ...
            styleUrl: L(Nq),
            visibility: L(No)
        }, O(yq, { MultiTrack: L(function(a, c) {
                var d = P([], or, a, c);
                if (d) {
                    var e = new T(null);
                    no(e, d);
                    return e } }, "geometry"), Track: L(Rq, "geometry") })),
        ur = O(zq, {
            color: L(Lq),
            fill: L(No),
            outline: L(No)
        }),
        hr = O(zq, { SimpleData: function(a, c) {
                var d = a.getAttribute("name");
                if (null !== d) {
                    var e = U(a);
                    c[c.length - 1][d] = e } } }),
    ...
    var Pr = O(zq, ["Document", "Placemark"]),
        ...
        Fr = O(zq, {
            MultiGeometry: N(function(a, c, d) { a = { node: a };
                var e = c.X(),
        ...
        Ir = O(zq, { coordinates: N(function(a, c, d) { d = d[d.length - 1];
                var e = d.layout;
                d = d.stride;
        ...
        hs = O(zq, {
            IconStyle: N(function(a, c, d) { a = { node: a };
                var e = {},
                    f = c.Db(),
                    g = c.hd(),
                    h = { href: c.b.l };
            ...
            LineStyle: N(function(a, c, d) { a = { node: a };
    ...
    var ws = [null, "http://www.opengis.net/ows/1.1"],
        vs = O(ws, { ServiceIdentification: L(function(a, c) {
                return P({}, xs, a, c) }), ServiceProvider: L(function(a, c) {
                return P({}, ys, a, c) }), OperationsMetadata: L(function(a, c) {
                return P({}, zs, a, c) }) }),
        As = O(ws, { DeliveryPoint: L(U), City: L(U), AdministrativeArea: L(U), PostalCode: L(U), Country: L(U), ElectronicMailAddress: L(U) }),
        Bs = O(ws, { Value: Kl(function(a) {
                return U(a) }) }),
        ...
        Fs = O(ws, { Get: Kl(function(a, c) {
                var d = ss(a);
                return d ? P({ href: d }, Hs, a, c) : void 0 }), Post: void 0 }),
        Is = O(ws, { DCP: L(function(a, c) {
                return P({}, Gs, a, c) }) }),
        ...
        Hs = O(ws, { Constraint: Kl(function(a, c) {
                var d = a.getAttribute("name");
        ...
        ys = O(ws, { ProviderName: L(U), ProviderSite: L(ss), ServiceContact: L(function(a, c) {
                return P({}, Js, a, c) }) });
    ...
    l.Bd = function(a, c) { a = ho(a, !0, go(this, c));
        var d = a.ga(),
            e = a.ra();
        Ks(d, d.length, e, d);
    ...
    function Ts(a, c, d, e, f) { a = a.geometries;
        var g = [],
            h, k;
        h = 0;
    ...
    var ct = { "http://www.opengis.net/wfs": { totalInserted: L(So), totalUpdated: L(So), totalDeleted: L(So) } },
        dt = { "http://www.opengis.net/ogc": { FeatureId: Il(function(a) {
        ...
        Zs = { "http://www.opengis.net/wfs": { TransactionSummary: L(function(a, c) {
                    return P({}, ct, a, c) }, "transactionSummary"), InsertResults: L(function(a, c) {
                    return P([], et, a, c) }, "insertIds") } };
    ...
    l.yf = function() {
        if (this.match(2)) {
            var a = xt(this);
            if (this.match(3)) return a } else if (tt(this)) return null;
        throw Error(ut(this)); };
    l.xf = function() {
        if (this.match(2)) {
            var a = yt(this);
            if (this.match(3)) return a } else if (tt(this)) return [];
        throw Error(ut(this)); };
    l.zf = function() {
        if (this.match(2)) {
            var a = zt(this);
    ...
    At.prototype.a = function(a) {
        for (a = a.firstChild; a; a = a.nextSibling)
            if (1 == a.nodeType) return this.b(a);
        return null };
    At.prototype.b = function(a) { this.version = a.getAttribute("version").trim();
    ...
    var Jt = [null, "http://www.opengis.net/wms"],
        Bt = O(Jt, { Service: L(function(a, c) {
                return P({}, Kt, a, c) }), Capability: L(function(a, c) {
                return P({}, Lt, a, c) }) }),
        Lt = O(Jt, { Request: L(function(a, c) {
                return P({}, Mt, a, c) }), Exception: L(function(a, c) {
                return P([], Nt, a, c) }), Layer: L(function(a, c) {
                return P({}, Ot, a, c) }) }),
        Kt = O(Jt, {
            Name: L(U),
            Title: L(U),
        ...
        Pt = O(Jt, { ContactPersonPrimary: L(function(a, c) {
                return P({}, Qt, a, c) }), ContactPosition: L(U), ContactAddress: L(function(a, c) {
                return P({}, Rt, a, c) }), ContactVoiceTelephone: L(U), ContactFacsimileTelephone: L(U), ContactElectronicMailAddress: L(U) }),
        ...
        Ft = O(Jt, { Format: Kl(U), DCPType: Kl(function(a, c) {
                return P({}, Vt, a, c) }) }),
    ...
    var au = [null, "http://www.opengis.net/wmts/1.0"],
        ...
        Zt = O(au, { Contents: L(function(a, c) {
                return P({}, cu, a, c) }) }),
        cu = O(au, { Layer: Kl(function(a, c) {
                return P({}, du, a, c) }), TileMatrixSet: Kl(function(a, c) {
                return P({}, eu, a, c) }) }),
        du = O(au, {
            Style: Kl(function(a, c) {
                var d = P({}, fu, a, c);
            ...
            ResourceURL: Kl(function(a) {
                ...
                var d = P([], iu, a, c);
                return 2 != d.length ? void 0 : nc(d) }), Identifier: L(U) })),
        fu = O(au, { LegendURL: Kl(function(a) {
                var c = {};
                c.format = a.getAttribute("format");
                c.href = ss(a);
                return c }) }, O(bu, { Title: L(U), Identifier: L(U) })),
        gu = O(au, { TileMatrixSet: L(U) }),
        hu = O(au, { Default: L(U), Value: Kl(U) }, O(bu, { Identifier: L(U) })),
        iu = O(bu, { LowerCorner: Il($t), UpperCorner: Il($t) }),
        eu = O(au, { WellKnownScaleSet: L(U), TileMatrix: Kl(function(a, c) {
                return P({}, ju, a, c) }) }, O(bu, { SupportedCRS: L(U), Identifier: L(U) })),
    ...
    function ou(a, c, d, e, f) {
        ...
        return nu(function(e) {
            return [a, c + (d - c) * e] }, rd(g, e), f) }

    function pu(a, c, d, e, f) {
        var g = ad("EPSG:4326");
        return nu(function(e) {
            return [c + (d - c) * e, a] }, rd(g, e), f) };
    ...
    function zu(a) { a = a.dataTransfer.files;
        var c, d, e;
        c = 0;
    ...
    function Ku(a) { this.c !== Pu && this.c !== Nu || !this.oa(a) || (this.S = !0);
        var c = !this.S;
    ...
    function Su(a, c) {
        if (a.s) {
            ...
            Wu(a) } else d = c.coordinate.slice(), a.D ? a.D.W().ma(d) : (a.D = new xl(new E(d)), Wu(a));
        return !0 }
    ...
    function Mu(a) {
        var c; "Point" === a || "MultiPoint" === a ? c = Ou : "LineString" === a || "MultiLineString" === a ? c = Pu : "Polygon" === a || "MultiPolygon" === a ? c = Nu : "Circle" === a && (c = Uu);
        return c }
    var Ou = "Point",
        Pu = "LineString",
        Nu = "Polygon",
    ...
    l.hm = function(a, c) {
        var d = c.Z(),
            e, f, g;
        f = 0;
        for (g = d.length; f < g; ++f) e = d[f], e = { feature: a, geometry: c, depth: [f], index: f, ka: [e, e] }, this.a.Aa(c.G(), e) };
    l.dh = function(a, c) {
        var d = c.Z(),
            e, f, g, h;
        e = 0;
        for (f = d.length - 1; e < f; ++e) g = d.slice(e, e + 2), h = { feature: a, geometry: c, index: e, ka: g }, this.a.Aa(nc(g), h) };
    l.gm = function(a, c) {
        var d = c.Z(),
            e, f, g, h, k, m, n;
        h = 0;
        ...
        if (c) {
            ...
            for (var g = 0, h = e.length; g < h; ++g) {
                ...
                if (Vb(m[0], c) && !f[n][0]) this.l.push([k, 0]), f[n][0] = k;
                    ...
                    if ("LineString" !== k.geometry.X() && "MultiLineString" !== k.geometry.X() || !f[n][0] || 0 !== f[n][0].index) this.l.push([k, 1]), f[n][1] = k } else x(m) in this.oa && !f[n][0] &&
                    !f[n][1] && d.push([k, c])
            }
            d.length && fv(this, a);
    ...
    function nv(a) {
        ...
        if (f) g.fd(a.pixel, function(a, c) {
            if (this.o(a, c)) { m.push(a);
                var d = x(a);
                this.a[d] = c;
                return !this.s } }, this, this.l), 0 < m.length && 1 == h.Zb() && h.item(0) == m[0] || (n = !0, 0 !== h.Zb() && (k = Array.prototype.concat(h.a), h.clear()), h.jf(m), 0 === m.length ? nb(this.a) : 0 < k.length && k.forEach(function(a) { a = x(a);
    ...
    function ov() {
        ...
        return function(c) {
            return a[c.W().X()] } }
    l.lm = function(a) { a = a.element;
        var c = this.A;
        c && c.ki(a) };
    l.om = function(a) { a = a.element;
        var c = this.A;
        c && c.mi(a) };
    ...
    l.mb = function(a, c) {
        ...
        if (f) {
            var g = this.a,
                h = [];
            em(g, f, function(c) { a === c.feature && h.push(c) });
    ...
    function qv(a) {
        ...
        if (0 < h.length) {
            ...
            h = h[0].ka;
            if (this.na && !this.T) {
                if (e = c.Ga(h[0]), k = c.Ga(h[1]), e = Xb(d, e), d = Xb(d, k), k = Math.sqrt(Math.min(e, d)), k = k <= this.c) f = !0, m = e > d ? h[1] : h[0], g = c.Ga(m) } else this.T && (m = Sb(e, h), g = c.Ga(m), Math.sqrt(Xb(d, g)) <= this.c && (f = !0, this.na && (e = c.Ga(h[0]), k = c.Ga(h[1]), e = Xb(g, e), d = Xb(g, k), k = Math.sqrt(Math.min(e,
    ...
    function vv(a) { this.l = zv(this, a.pixel, a.map);
            ...
            this.g.forEach(function(c) {
                ...
                if (0 == d || 1 == d) { a++;
                    ...
                    e = C(c, "change", function() {
                        var d = c.V();
                        if (2 == d || 3 == d || 4 == d) sb(e), a--, 0 === a && (this.Qc.forEach(sb), this.Qc = null, this.wd()) }, this);
                    this.Qc.push(e) } }, this);
    ...
    l.Lb = function(a, c, d, e, f) {
        if (this.f && f && !qd(this.f, f)) {
            ...
            e = new Cv(h, d, f, k, c, m, this.Yb(e), this.$e(), function(a, c, d, e) {
                return Fv(this, a, c, d, e, h) }.bind(this), this.oa, this.B);
            g.set(a, e);
            return e }
    ...
    function Fv(a, c, d, e, f, g) {
        ...
        if (Rf(a.a, k)) {
            if (h = a.a.get(k), h.key != m) {
                ...
                h.a && (h.a.a = null);
                a.a.replace(k, h) } } else h = Ev(a, c, d, e, f, g, m), a.a.set(k, h);
        return h }
    l.nb = function(a) {
    ...
    Jv.prototype.T = function(a, c) {
        ...
        if (200 <= d.status && 300 > d.status) {
            var e;
            try { e = JSON.parse(d.responseText) } catch (f) { Zf(this, "error");
                return }
            Lv(this, e);
    ...
    function Mv(a) {
        if (void 0 !== a.B) { a.A.length = 0;
            for (var c = oc(), d = a.oa * a.B, e = a.s.je(), f = {}, g = 0, h = e.length; g < h; g++) {
                var k = e[g];
                x(k).toString() in f || !(k = a.Y(k)) || (k = k.Z(), zc(k, c), qc(c, d, c), k = a.s.Ze(c), k = k.filter(function(a) { a = x(a).toString();
                    return a in f ? !1 : f[a] = !0 }), a.A.push(Nv(a, k))) } } }
    ...
    function Tv(a, c, d, e, f, g) { g[a.s ? "CRS" : "SRS"] = f.kb; "STYLES" in a.i || (g.STYLES = new String(""));
        if (1 != e) switch (a.Y) {
            case "geoserver":
                e = 90 * e + .5 | 0;
                ...
                2: [function(a, c) {
                    ...
                    function h(a, c) {
                        var e = Object.keys(a.lib || {}).map(function(c) {
                                return "var " + c + " = " + a.lib[c].toString() + ";" }).concat(["var __minion__ = (" + g.toString() + ")(", a.operation.toString(),
                    ...
                    function k(a, c) {
                        var e = g(a.operation);
                        return { postMessage: function(a) { setTimeout(function() { c({ data: { buffer: e(a), meta: a.meta } }) }, 0) } } }
    ...
    Zv.prototype.B = function(a, c, d, e) {
        ...
        for (var f, g = 0, h = this.c.length; g < h; ++g)
            if (f = this.c[g].a.ea(), "ready" !== f.V()) { d = !1;
                break }
        if (!d) return null;
    ...
    Zv.prototype.S = function(a, c) {
        for (var d = this.c.length, e = Array(d), f = 0; f < d; ++f) {
            ...
            if (g.o(h, k)) {
                ...
                g.c(h, k, cw);
                g = cw.getImageData(0, 0, m, n) } else g = null;
            if (g) e[f] = g;
            else return }
        d = {};
    ...
    function lw(a, c, d) { Vf.call(this, a, 2);
        ...
        this.g = {} }
    y(lw, Vf);
    lw.prototype.fb = function(a) { a = void 0 !== a ? x(a) : -1;
    ...
    y(nw, W);
    l = nw.prototype;
    l.Fn = function(a) { a = a.target;
        if (200 <= a.status && 300 > a.status) {
            var c;
            try { c = JSON.parse(a.responseText) } catch (d) { this.Yd();
                return }
    ...
    l.rh = function(a) {
        ...
        if (void 0 !== a.attribution && !this.da()) { c = void 0 !== e ? e : c.G();
            e = {};
    ...
    l.sc = function(a, c, d) {
        var e = this.tileGrid;
        e || (e = this.eb(d));
        if (!(e.Kb().length <= a[0])) { 1 == c || this.S && void 0 !== this.A || (c = 1);
            var f = e.$(a[0]),
                g = e.Da(a, this.T),
    ...
    function Z(a) {
        function c(a) { a = "KVP" == e ? $p(bq([a], g)) : a.replace(/\{(\w+?)\}/g, function(a, c) {
    ...
    u("ol.render.toContext", function(a, c) {
        ...
        return new sk(a, f, d, e, 0) }, OPENLAYERS);
    ...
    u("ol.proj.fromLonLat", function(a, c) {
        return td(a, "EPSG:4326", void 0 !== c ? c : "EPSG:3857") }, OPENLAYERS);
    u("ol.proj.toLonLat", function(a, c) {
        return td(a, void 0 !== c ? c : "EPSG:3857", "EPSG:4326") }, OPENLAYERS);
    ...
    u("ol.events.condition.platformModifierKeyOnly", function(a) { a = a.originalEvent;
        return !a.altKey && ($g ? a.metaKey : a.ctrlKey) && !a.shiftKey }, OPENLAYERS);
